...
const blinkInWTFDelays = [1, 1.5, 2];
const blinkInRemainingDelays = [3, 3.5, 4];
...
export const WTF = ({ className }: Props) => {
  ...
  const handleMouseMove = (e: { pageX: any; pageY: any }) => {
    if (wtfRef.current) {
      setMousePosition(getRelativeCoordinates(e, wtfRef.current));
    }
  };
  ...
  return (
    <motion.div
      ref={wtfRef}
      className="w-full"
      onMouseMove={(e: { pageX: any; pageY: any }) => handleMouseMove(e)}
    >
              ...
              <motion.path
                ...
                variants={{
                  ...blinkIn,
                    ...
                    ...blinkIn.end,
                    transition: {
                      ...blinkIn.end.transition,
                      delay: blinkInWTFDelays[2],
                    },
                  },
                }}
                initial="start"
              ...
              <motion.g
                variants={{
                  ...blinkIn,
                    ...
                    transition: {
                      ...blinkIn.end.transition,
                      delay: blinkInRemainingDelays[2],
                    },
                  },
                }}
                initial="start"
              ...
              <motion.g
                variants={{
                  ...blinkIn,
                    ...
                    transition: {
                      ...blinkIn.end.transition,
                      delay: blinkInRemainingDelays[1],
                    },
                  },
                }}
                initial="start"
              ...
              <motion.g
                variants={{
                  ...blinkIn,
                    ...
                    transition: {
                      ...blinkIn.end.transition,
                      delay: blinkInRemainingDelays[0],
                    },
                  },
                }}
                initial="start"
